...
let entradaCorDoJogador = document.getElementById("cor_do_jogador");
...
aWebSocket.onmessage = function(event) {
    ...
    pontuacao.innerHTML = "Pontuação: " +  estado.pontuacao;
};
...
function atualizaCanvas() {
    ...
    contcanvas.fillStyle = entradaCorDoJogador.value;
